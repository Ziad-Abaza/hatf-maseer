            ...
            <div class="card-header flex-column flex-md-row" id="hide">
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group">
                            <button onclick="printDiv('products')"
                        ...
                        <div class="btn-group">
                            <a href="{{ route('products.create') }}" class="btn btn-secondary create-new btn-primary"
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($products as $product)
                            <tr>
                                {{-- <td>
                                    <ul>
                                        <li>{{ Str::limit(de_ar($product['content']), 10, '...') }}</li>
                                        <li>{{ Str::limit(de_en($product['content']), 10, '...') }}</li>
                                    </ul>
                                </td> --}}

                                <!-- Image Preview -->
                                <td class="text-center">
                                    <img src="{{ $product->getFirstMediaUrl('products') }}" alt="product Image"
