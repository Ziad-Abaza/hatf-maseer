            ...
            <div class="card-header flex-column flex-md-row" id="hide">
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('advatages.create') }}" class="btn btn-secondary create-new btn-primary"
            ...
            <div id="myTabel">
                <table class="datatables-basic table table-hover table-striped align-middle">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($advantages as $advatage)
                            <tr>
                                {{-- <td>
                                    <ul>
                                        <li>{{ Str::limit(de_ar($advatage['content']), 10, '...') }}</li>
                                        <li>{{ Str::limit(de_en($advatage['content']), 10, '...') }}</li>
                                    </ul>
                                </td> --}}

                                <!-- Image Preview -->
                                <td class="text-center">
                                    <img src="{{ $advatage->getFirstMediaUrl('advantages') }}" alt="Banner Image"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a class="dropdown-item text-primary"
                                                href="{{ route('advatages.edit', $advatage->id) }}">
                                                <i class="ti ti-pencil"></i> {{ __('dash/index.edit') }}
                                            </a>

                                            <!-- Show -->
                                            <a class="dropdown-item text-primary"
                                                href="{{ route('advatages.show', $advatage->id) }}">
                                                <i class="ti ti-eye"></i> {{ __('dash/index.show') }}
                                            </a>

                                            <!-- Delete -->
                                            <form action="{{ route('advatages.destroy', $advatage->id) }}" method="POST"
