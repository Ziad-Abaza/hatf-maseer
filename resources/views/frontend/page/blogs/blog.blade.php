...
<div class="container-fluid px-0" dir="{{ $dir }}">
    ...
    <div class="blog-header py-5 py-md-7 mb-5 text-center position-relative"
        style="background: #f8f9fa; margin-top: 40px;">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="main-title">
                        ...
                        <div class="header-divider mx-auto animate__animated animate__fadeIn animate__delay-1s"
                            style="background: linear-gradient(90deg, rgba(0,0,0,0) 0%, #495057 50%, rgba(0,0,0,0) 100%);">
                        </div>
