            ...
            <div class="col-12 col-lg-6">
                <div class="container">
                    <div class="py-2 text-center translatable reverse-text fw-bold text-white"
                        data-ar="{{ __('frontend/contact.contact_whatsapp.contact_whatsapp') }}" data-en="Contact us on WhatsApp">
                        <h2 class="fw-bold text-white" id="langText">{{ __('frontend/contact.contact_whatsapp.contact_whatsapp') }}</h2>
                    </div>
